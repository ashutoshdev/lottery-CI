...
<head>
  ...
  <title><?php // echo $pageTitle; ?>Lottery Games</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="<?php echo base_url(); ?>" class="logo">
          ...
          <span class="logo-lg">Lottery</span>
        </a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          ?>
            ...
            <li>
              <a href="<?php echo base_url('web/winner'); ?>">
                <i class="fa fa-history"></i>
            ...
            <li>
              <a href="<?php echo base_url('web/wallet'); ?>">
                <i class="fa fa-history"></i>
            ...
            <li>
              <a href="<?php echo base_url('web/refund'); ?>">
                <i class="fa fa-history"></i>
            ...
            <li>
              <a href="<?php echo base_url('web/withdrawl'); ?>">
                <i class="fa fa-history"></i>
            ...
            <li>
              <a href="<?php echo base_url('web/transfer'); ?>">
                <i class="fa fa-history"></i>
            ...
            <li>
              <a href="<?php echo base_url('game/result'); ?>">
                <i class="fa fa-history"></i>
                <span>Result</span>
              </a>
            </li>
