        ...
        <div class="row">
          <div class="col-md-3">
            ...
            <a href="<?php echo base_url() ?>account/winner_history"  class="nav-link"><i class="fas fa-history"></i>Winner History</a>
                ...
                <li>
                  <a href="<?php echo base_url() ?>account/order_history"  class="nav-link active"><i class="fas fa-history"></i>Play History</a>
                </li>
                <li class="nav-item">
          ...
          <div class="col-md-9">
            ...
            <div class="tab-content myaccount_content">
              ...
              <div class="tab-pane active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                  <h4 class="mb-3"  style="color:green">Play History List</span></h4>
