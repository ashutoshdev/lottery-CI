          ...
          <div class="col-md-3">
            <div class="account_menu">
              <ul class="nav flex-column">
                ...
                <li>
            <a href="<?php echo base_url() ?>account/winner_history"  class="nav-link active"><i class="fas fa-history"></i>Winner History</a>
            </li>
                <li>
          ...
          <div class="col-md-9">
            ...
            <div class="tab-content myaccount_content">
              ...
              <div class="tab-pane active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                  ...
                  <h4 class="mb-3"  style="color:green">Winner Amount - $ <?php echo $amount->sum; ?></span></h4>
