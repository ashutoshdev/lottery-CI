              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group col-md-9">
                      ...
                      <label for="inputState">Draw Date</label>
                      ...
                      <br>
                      <label for="inputState">Draw</label>
                      <select name="draw" id="totaldraw" class="form-control">
                        <?php
                          for($k=1;$k<=10;$k++){
                            echo "<option value='".$k."'>$k Draw</option>";
                          }
...
<?php
                        if($range->web_id==1){
                          ?>
                          <input class="check_con" checked type="checkbox" value="thursday" name="day[]"> Thursday

                          <input class="check_con"  checked type="checkbox" value="sunday" name="day[]"> Sunday
                          <?php
                        }
                        else if($range->web_id==2 || $range->web_id==3  || $range->web_id==4  || $range->web_id==5){
                          ?>
                          <input class="check_con"  checked type="checkbox" value="wednesday" name="day[]"> Wednesday

                          <input class="check_con"  checked type="checkbox" value="saturday" name="day[]"> Saturday
                          <?php
                        }
                        else if($range->web_id==6){
                          ?>
                          <input class="check_con"  checked type="checkbox" value="saturday" name="day[]"> Saturday
                          <?php
                        }
    ...
    <div class="picknumber_sec">
      <div class="container">
          ...
          <input type="submit" value="Add To Cart" id="addclickcart" class="btn btn-warning">
            ...
            ?>
                      <span style="color:red;">Note: Game Date is not updated still. Please try after date update.</span>
            <?php
          }
          ?>
      </div>
      ...
      <div class="container">
        <div class="row mb-3">
          ...
          <div class="col-md-4 text-lg-right">
            <!-- <a href="<?php echo base_url('game/result'); ?>" class="btn btn-warning" role="button" aria-pressed="true">Results</a> -->
          </div>
        </div>
...
<div class="pricetier mt-4">
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover">
              <thead>
                  <tr>
                    <th scope="col">NUMBERS MATCHED(White Ball + Mega Ball)</th>
...
const second = 1000,
      ...
      // alert("Yes");
let countDown = new Date('<?php echo date("M d, Y 00:00:00",strtotime("+1 day", strtotime($dates[0]->date))) ?>').getTime(),
...
$("#addclickcart").click(function(e){
  ...
  if ($('.check_con').filter(':checked').length < 1){
    alert("Please select atleast one draw day");
    return false;
  }
