                ...
                <div class="box box-primary">
                    <!-- form start -->
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <h3><b>Quick Play Quantity</b> - <?php echo $RangeInfo->quantity; ?></h3>
                                    </div><!-- /.box-header -->
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="box-footer">
                            ...
                            <a href="<?php echo base_url('web/addtwoWebdate')."/".$WebInfo->id; ?>" class="btn btn-primary">Add Next Two Date</a>
