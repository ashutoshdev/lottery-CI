          ...
          <div class="col-md-3">
            <div class="account_menu">
              <ul class="nav flex-column">
                ...
                <li>
                  <a href="<?php echo base_url() ?>account/order_history"  class="nav-link"><i class="fas fa-history"></i>Order</a>
                </li>
                <li class="nav-item">
                    ...
                    <?php } 
                        ...
                        <?php } ?>
                              ...
                              <div class="row mt-3">
                                ...
                                <input type="number" value="" min="1" id="addpay" name="add_pay"  placeholder="Enter Number e.g. 10" class="form-control">
                                <br>
                                ...
                                <form>
                                  <button type="button" class="btn btn-primary" style="cursor:pointer;" value="Pay Now with Rave" id="submit">Pay Now with Rave</button>
                                </form>
                                <br>
