    ...
    <div class="picknumber_sec">
      <div class="container">
          <div class="lottery-carousel owl-carousel owl-theme">
              
              <div class="item">
                <div class="quizno_box">
                <div class="quiznobox_header"><h4>First Entry</h4></div>
                  ...
                  <div class="quiznobox_body upper_div first_rk">
                      ...
                      for($i=(int) $range->white_from; $i<=(int) $range->white_to; $i++){
                          ?>
                            <li class="<?php if($counter<=(int) $range->white_ball){ echo "selected";} ?>"><input name="white_btn1[]" <?php if($counter<=(int) $range->white_ball){ echo "checked";} ?> class="lottery_number " type="checkbox" value="<?php echo $i;?>" id="l<?php echo $i;?>"><?php echo $i; ?></li>
                          <?php
                          $counter++;
                        }
                      ?>
                  ...
                  <div class="quiznobox_body lower_div first_rk1">
                    ...
                    $counter=0;
                      for($i=(int) $range->yellow_from; $i<=(int) $range->yellow_to; $i++){
                          ?>
                            <li class="<?php if($counter<(int) $range->yellow_ball){ echo "selected";} ?>"><input class="lottery_number" name="yellow_bt1[]" type="checkbox"  <?php if($counter<(int) $range->yellow_ball){ echo "checked";} ?> value="<?php echo $i;?>" id="l<?php echo $i;?>"><?php echo $i; ?></li>
                          <?php
                      $counter++;  
                      }
                        ?>
              ...
              <div class="item itm_2"  style="display:none;">
                <div class="quizno_box">
                
                <div class="quiznobox_header"><h4>Second Entry</h4></div>
                  <!-- <div class="quiznobox_header">
                      <button type="button" class="btn btn-dark btn-block">Quick Pick</button>
                  </div> -->
                  <div class="quizstrip">
                  ...
                  <div class="quiznobox_body upper_div second_rk">
                      <ul><?php
                      $counter =1;
                      for($i=(int) $range->white_from; $i<=(int) $range->white_to; $i++){
                          ?>
                            <li class="<?php if($counter<=(int) $range->white_ball ){ echo "selected";} ?>"><input name="white_btn2[]" <?php if($counter<=(int) $range->white_ball ){ echo "checked";} ?> class="lottery_number " type="checkbox" value="<?php echo $i;?>" id="l<?php echo $i;?>"><?php echo $i; ?></li>
                          <?php
                          $counter++;
                        }
                      ?>
                  ...
                  <div class="quiznobox_body lower_div second_rk1">
                      <ul>
                    ...
                    $counter=0;
                      for($i=(int) $range->yellow_from; $i<=(int) $range->yellow_to; $i++){
                          ?>
                            <li class="<?php if($counter<(int) $range->yellow_ball){ echo "selected";} ?>"><input class="lottery_number" name="yellow_bt2[]" type="checkbox"  <?php if($counter<(int) $range->yellow_ball){ echo "checked";} ?> value="<?php echo $i;?>" id="l<?php echo $i;?>"><?php echo $i; ?></li>
                          <?php
                      $counter++;  
                      }
                        ?>
              ...
              <div class="item itm_3" style="display:none;">
                <div class="quizno_box">
                
                <div class="quiznobox_header"><h4>Third Entry</h4></div>
                  ...
                  <div class="quiznobox_body upper_div third_rk">
                      <ul><?php
                      $counter =1;
                      for($i=(int) $range->white_from; $i<=(int) $range->white_to; $i++){
                          ?>
                            <li class="<?php if($counter<=(int) $range->white_ball){ echo "selected";} ?>"><input name="white_btn3[]" <?php if($counter<=(int) $range->white_ball){ echo "checked";} ?> class="lottery_number" type="checkbox" value="<?php echo $i;?>" id="l<?php echo $i;?>"><?php echo $i; ?></li>
                          <?php
                          $counter++;
                        }
                      ?>
                  ...
                  <div class="quiznobox_body lower_div third_rk1">
                      <ul>
                    ...
                    $counter=0;
                      for($i=(int) $range->yellow_from; $i<=(int) $range->yellow_to; $i++){
                          ?>
                            <li class="<?php if($counter<(int) $range->yellow_ball){ echo "selected";} ?>"><input class="lottery_number" name="yellow_bt3[]" type="checkbox"  <?php if($counter<(int) $range->yellow_ball){ echo "checked";} ?> value="<?php echo $i;?>" id="l<?php echo $i;?>"><?php echo $i; ?></li>
                          <?php
                      $counter++;  
                      }
                        ?>
...
$("#addclickcart").click(function(e){
  ...
  $val = $("#inputState").val();
  var totalChecked =0;
    $('.first_rk').find("input[type=checkbox]:checked").each(function(){
      totalChecked++;
    }); 
    if(totalChecked<$white_ball){
      alert("Please select "+$white_ball+" numbers from upper numbers of First Entry!");
      return false;
    }

    if($yellow_ball>1){
      var totalChecked  = 0;
      $('.first_rk1').find("input[type=checkbox]:checked").each(function(){
        totalChecked++;
      }); 
      if(totalChecked<$yellow_ball){
        alert("Please select "+$yellow_ball+" numbers from lower numbers of First Entry!");
        return false;
      }
    }
